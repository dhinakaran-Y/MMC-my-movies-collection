...
export default function WatchListMovieCard({ movie }) {
  ...
  useEffect(() => {
    if (!user?._id) return;
    let cancelled = false;
    // For custom movies, skip TMDB watch providers
    if (isCustom) {
    ...
    <div className="group relative flex flex-col bg-dark-body2 rounded-xl overflow-hidden border border-white/5 shadow-lg">
      ...
      <div
        ...
        <div className="w-full flex flex-col items-center my-auto">
          <h1 className="w-full px-2 text-orange-600/90 font-bold text-center text-lg lg:text-2xl font-mono mb-2 capitalize break-words line-clamp-2">
            {mediaTitle}
          </h1>
