    ...
    <div className="brightness-70 relative">
      ...
      <div className="absolute flex-col space-y-3 text-white/90 font-semibold bg-black/80 top-0 right-0 left-0 bottom-0 flex items-center justify-center opacity-0 text-div hover:opacity-100 transition-all duration-300">
        ...
        <div className="absolute bottom-10 grid grid-cols-2 gap-5">
          ...
          <button
            type="button"
            className="flex cursor-pointer items-center justify-center space-x-1 bg-red1/80 rounded py-2 px-2 hover:bg-red-600 active:scale-105 transition-all duration-300">
            <span>
              {/* watched */}
              <svg
                xmlns="http://www.w3.org/2000/svg"
          ...
          <button
            type="button"
            className="flex cursor-pointer items-center justify-center space-x-1 bg-blue1/80 rounded py-2 px-2 hover:bg-blue-600 active:scale-105 transition-all duration-300">
            <span>
              {/* add collection */}
              <svg
                xmlns="http://www.w3.org/2000/svg"
